...
<div class="card card-default">
    <div class="card-header">
        <h3 class="card-title">{{trans('app.create new')}} - {{trans('app.categories')}}</h3>
    </div>
        ...
        <div class="card card-primary card-outline card-outline-tabs">
            ...
            <div class="card-body">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                        <div class="form-group">
                            <input type="checkbox" value="1"  id="display_title" name="display_title" checked class="chk-col-teal">
                            <label for="display_title">Display Title</label>
                    
                            <input type="checkbox"  value="1" id="display_icon"  name="display_icon" class="chk-col-teal">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                        <div class="form-group">
                            <div class="form-line">
                            {!! Form::select('type', ['Custom Link','Category'],null, array('required', 'class'=>'form-control')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row clearfix customlink">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                        <div class="form-group">
                            <div class="form-line">
                            {!! Form::text('customlink', null, array( 'class'=>'form-control')) !!}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row clearfix">
                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label" style="text-align: left;">
                    {!! Form::label(trans('app.parent')) !!}
                    </div>
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                        <div class="form-group">
                            <div class="form-line">
                            {!! Form::select('parent_id',App\Models\MenuLink::listsTranslations('title')->pluck('title','id'),null, array( 'class'=>'form-control', 'placeholder'=>trans('app.root'))) !!}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row clearfix category_id">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                        <div class="form-group">
                            <div class="form-line">
                            {{Form::select("category_id",App\Models\Category::listsTranslations('title')->pluck('title','id'),null,['class'=>'form-control', 'placeholder'=>trans('app.root')])}}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row clearfix hasSubs">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                        <div class="form-group">
                            <div class="form-line">
                            {!! Form::select('hasSubs', ['0'=>'No','1'=>'Yes'],null, array('class'=>'form-control', 'placeholder'=>trans('app.root'))) !!}
                            </div>
                        </div>
                    </div>
                </div>
