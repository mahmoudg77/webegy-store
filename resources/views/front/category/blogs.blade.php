...
@php($category=App\Models\Category::find(60))
<!--============== Blog Area Start ==============-->
<div class="full-row mx-auto pt-20 blogs" style="min-height:300px">
    <div class="container-fluid">
        <div class="row pb-20">
            <div class="col-lg-12">
                {{-- @include('partials/news-filter-form',['category'=>null,'chields'=>$category->Chields,'type'=>7, 'main_category'=>$category])
                --}}
            ...
            <div class="row">
                <div class="col-lg-12 sm-mb-30">
                    <div class="row">
                        ...
                        @else
                        <div class="col col-xs-12 text-center pt-50 pb-50">
